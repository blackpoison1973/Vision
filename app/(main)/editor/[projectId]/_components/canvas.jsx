...
import { Crop, Type, MousePointer, Save } from "lucide-react"; // ✅ Lucide icons
...
function CanvasEditor({ project }) {
  ...
  return (
    <div className="relative flex flex-col w-full h-full">
      {/* Toolbar */}
      <div className="flex gap-2 p-2 bg-secondary border-b border-border">
        <Button
        ...
        <Button onClick={saveCanvasState} size="sm" variant="outline">
      ...
      <div
        ref={containerRef}
        className="relative flex flex-1 items-center justify-center bg-secondary w-full h-full overflow-hidden"
      >
        <div
