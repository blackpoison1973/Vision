...
export const FloatingShapes = () => {
  ...
  const shapes = [
    ...
    },
    {
      ...
      gradient: "from-green-400/40 to-cyan-500/40",
    },
  ];
  ...
  return (
    <div className="fixed inset-0 overflow-hidden pointer-events-none">
      {shapes.map((shape) => (
        <div
          key={shape.id}
          className={`absolute ${shape.size} ${shape.position} bg-gradient-to-r ${shape.gradient} rounded-full blur-3xl opacity-25 animate-pulse`}
          style={{
